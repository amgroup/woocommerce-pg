...
class WC_Order {
	...
	/** @public string Shipping DISCOUNTED cost */
	public $order_shipping;

	/** @public string Shipping REAL cost */
	public $order_shipping_real;
	...
	/**
	 * Gets DISCOUTNTED shipping total - As it seems for Customer.
	 *
	 * @access public
	 * @return float
	 */
	...
	/**
	 * Gets REAL shipping total. Your spended money for shipping.
	 *
	 * @access public
	 * @return float
	 */
	public function get_shipping_real() {
		return apply_filters( 'woocommerce_order_amount_shipping_real', number_format( (double) $this->order_shipping_real, 2, '.', '' ) );
	}
