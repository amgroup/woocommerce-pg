...
function woocommerce_meta_boxes() {
	...
	add_meta_box( 'woocommerce-product-tsv-synonyms', __( 'Search Synonyms/Keywords', 'woocommerce' ), 'woocommerce_product_synonyms_box', 'product', 'side' );
	...
	remove_meta_box( 'slugdiv', 'shop_coupon' , 'normal' );
        ...
        // Discounts
	add_meta_box( 'woocommerce-discount-data', __( 'Discount Data', 'woocommerce' ), 'woocommerce_discount_data_meta_box', 'shop_discount', 'normal', 'high');

	remove_meta_box( 'woothemes-settings', 'shop_discount' , 'normal' );
...
function woocommerce_pre_post_update( $post_id ) {
	...
	if ( isset( $_POST['_stock_status_date'] ) )
