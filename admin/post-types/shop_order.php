	...
	switch ( $column ) {
		...
		case "order_title" :
			...
			if ( ! empty( $user_info ) ) {
           	...
           	if ( $the_order->shipping_email )
        		echo '<small class="meta">(' . __( 'Recipient Email:', 'woocommerce' ) . ' ' . '<a href="' . esc_url( 'mailto:' . $the_order->shipping_email ) . '">' . esc_html( $the_order->shipping_email ) . '</a>)</small>';


        	if ( $the_order->billing_phone )
        		echo '<small class="meta">' . __( 'Tel:', 'woocommerce' ) . ' ' . esc_html( $the_order->billing_phone ) . '</small>';
        	if ( $the_order->shipping_phone )
        		echo '<small class="meta">(' . __( 'Recipient Tel:', 'woocommerce' ) . ' ' . esc_html( $the_order->shipping_phone ) . ')</small>';
		break;
		case "billing_address" :
        	...
        	if ( $the_order->payment_method_title )
        		echo '<small class="meta">' . esc_html( $the_order->payment_method_title ) . '</small>';
		break;
		case "shipping_address" :
        	...
        	if ( $the_order->shipping_method_title )
        		echo '<small class="meta">' . esc_html( $the_order->shipping_method_title ) . '</small>';
		break;
		case "total_cost" :
