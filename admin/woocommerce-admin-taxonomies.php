 ...
 */
/* TODO
function woocommerce_edit_category_submitbutton( $term, $taxonomy ) {
    ?>
        <input type="submit" class="button button-primary" name="submit_and_return" value="Update and return" onclick="" />
    <?php
}
add_action( 'product_cat_edit_form', 'woocommerce_edit_category_submitbutton' );
*/
...
function woocommerce_category_fields_save( $term_id, $tt_id, $taxonomy ) {
	...
	if ( isset( $_POST['advertisement'] ) )
		update_woocommerce_term_meta( $term_id, 'advertisement', esc_attr( $_POST['advertisement'] ) );
